...
import { HiCode, HiDesktopComputer, HiLightBulb, HiOutlineQrcode, HiOutlineUserGroup, HiOutlineVideoCamera } from "react-icons/hi";
...
const workData = [
    {
        ...
        image: '',
        subTitle: "Before any project work begins. we need to create a product backlog."
    },
    {
        id:1,
        title: 'SPRINT PLANNING -SPRINT BACKLOG CREATION',
        image: '',
        subTitle: " In the second part of the Sprint planning session, we break down the stories"
    },
    {
        id:1,
        title: 'WORKING ON THE SPRINT',
        image: '',
        subTitle: "This is the time where the actual coding, testing, UI designing, echnical writeups"
    },
    {
        id:1,
             ...
             <div key={card.id} className="cards workCard">
               ...
               <div className="inner-box">
                 <div className={`cards-front cards-front2 cards-front5  ${i=== 2 ? 'cardsFront2' : ''} ${i=== 1 ? 'cardsFront3' : '' } ${i=== 3 ? 'cardsFront4' : '' } ` }>
                  ...
                  i === 0 ? <p ><HiDesktopComputer size={70}  /> </p>   : ''  
                   }
                
                   {
                    i === 2 ? <p ><HiOutlineVideoCamera size={70}  /> </p>   : ''  
                   }
                   {
                  i === 3 ? <p ><HiOutlineUserGroup size={70}  /> </p>   : ''  
                   }
                   {
                  i === 4 ? <p ><HiCode size={70}  /> </p>   : ''  
                   }
                   {
                    i === 5 ? <p ><HiOutlineQrcode size={70}  /> </p>   : ''  
                     }
