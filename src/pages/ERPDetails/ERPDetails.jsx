    ...
    <div>
      ...
      <Container>
        ...
        <div className="px-3 md:px-0">
          <Container>
            <h3 className="text-2xl uppercase text-[#1586FD] mb-3 font-semibold ">
              Key features{" "}
            </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3  lg:grid-cols-6   place-content-right ">
            {erpPriceData.map((data) => (
              <div key={data.id} className="erpPriceCard">
                ...
                <button className="bg-[#1586FD] text-white rounded-full text-[13px]  w-[100px] h-[30px]">
                  View Pricing{" "}
                </button>
              </div>
            ))}
          ...
          <table border={2} className="priceTable" width="auto">
            <tbody>
              ...
              <tr>
                ...
                <td>
                  {" "}
                  Loyalty Points Earning & Burning With OTP Authorization{" "}
                </td>
                <td>
                  <HiCheck size={25} className="text-[#198759] mx-auto" />{" "}
                </td>
