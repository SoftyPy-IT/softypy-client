import softypy from "../../../../src/assets/logo/logo.png";
import "./Footer.css";
import {
  FaPhoneAlt,
  FaLinkedin,
...
const Footer = () => {
  return (
    <div className="bg-[#2D57A2] text-[#fff] pt-16 pb-2 sectionMargin">
      <Container>
        <div className="footerWrap  ">
          <div className="contactUs">
            <div>
              <div className="w-full md:w-56 text-left">
                <img
                  className=" w-36 md:w-40 object-fill mx-auto"
                  src={softypy}
                  alt="softypy"
                />
                ...
                <div className="flex  md:flex-row mt-3 items-center">
                  <img className="mr-2" src={location} alt="location" />
                  <p className="mt-3">
                    Ka-121, (Besides of IFIC Bank, 2nd floor),Kuril, Vatara,
                    Dhaka -1229
                  </p>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="mt-3">
                ...
                <div className="flex items-center w-[150px] justify-between">
                  ...
                  <Link
                    target="_blank"
                    to="https://www.instagram.com/softypyit"
                  >
                    <div className="socialIcon">
                      <FaInstagram />
                    </div>
          ...
          <div className="py-3 copyRight flex flex-col md:flex-row justify-center md:justify-between gap-2 items-center ">
            <small className=" sm:mb-5">
              All Right reserve | @ 2023 - SoftyPy{" "}
            </small>
