        ...
        <div className="pl-3 md:pl-0 md:px-5 xl:px-0 ">
          <div className="mt-20 text-black">
            ...
            <ul className="space-y-2 mt-2 experienceList">
              ...
              <li>
                💠Experience with standard front-end development tools such as
                Babel, Webpack, NPM, etc., is a plus. Knowledge of Node Js is a
                plus.
              </li>
          ...
          <div className="mt-20 text-black">
            ...
            <ul className="space-y-2 mt-2 experienceList">
              <li>💠 -Diligent, innovative, and conscientious</li>
              <li> 💠 -Mastering design software</li>
              <li>💠 -Likes challenges</li>
              <li>💠 -Have a sense of art</li>
              <li>💠 -Have high creativity, communication, and action.</li>
            </ul>
          </div>
          <div className="mt-20 text-black">
            <h3 className="text-2xl md:text-4xl font-bold text-black mb-5">
            ...
            <ul className="space-y-2 mt-2 experienceList">
              <li>
                💠 A sense of community and friendship, diversity, and
                inclusivity
              </li>
              <li>
                💠 Informal working environment with short decision-making
                chains
              </li>
          ...
          <div className="block md:flex justify-end">
            ...
            <Link to="/careers-apply">
              {" "}
              <button className="applyBtn mt-5 ">Apply Now</button>
            </Link>
          </div>
        </div>
      </Container>
